...
namespace Server
{
    public class SkillPickGump : Gump
    {
        ...
        private const int SkillIncreaseValue = 100; // Skill value
        ...
        {
            m_SelectedSkills = new List<SkillName>(selectedSkills); // Deep copy the list to avoid modifying the original list
			...
			AddLabel(55, 472, 1153, $"| {NumberOfSkills}X GM SKILLBOOK | UO : GENESIS | PRE-T2A SHARD |");
            AddButton(460, 470, 2119, 2120, (int)Buttons.Close, GumpButtonType.Reply, 0);
            AddBackground(52, 60, 539, 407, 9350);
            AddImage(488, 338, 9000);
            AddPage(1);
            AddButton(530, 470, 2128, 2129, (int)Buttons.FinishButton, GumpButtonType.Reply, 0);
        ...
        private void AdjustSkillsToCapForPlayer(Mobile m, int skillCapValue, List<SkillName> selectedSkills)
        {
            ...
            if (excessPoints > 0)
            {
                double reductionFactor = 1.0 - (double)excessPoints / (double)totalSkillPoints;
                foreach (Skill skill in m.Skills)
                {
                    if (selectedSkills.Contains(skill.SkillName))
                    {
				...
				public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            SkillData[] skillsData = new SkillData[]
            {
                ...
                new SkillData(SkillName.Alchemy, 1, () => new List<Item> {}),
                new SkillData(SkillName.Anatomy, 2, () => new List<Item> {}),
                new SkillData(SkillName.AnimalLore, 3, () => new List<Item> {}),
                new SkillData(SkillName.AnimalTaming, 4, () => new List<Item> {}),
                new SkillData(SkillName.Archery, 5, () => new List<Item> {}),
                new SkillData(SkillName.ArmsLore, 6, () => new List<Item> {}),
                new SkillData(SkillName.Begging, 7, () => new List<Item> {}),
                new SkillData(SkillName.Blacksmith, 8, () => new List<Item> {}),
                new SkillData(SkillName.Camping, 9, () => new List<Item> {}),
                new SkillData(SkillName.Carpentry, 10, () => new List<Item> {}),
                new SkillData(SkillName.Cartography, 11, () => new List<Item> {}),
                new SkillData(SkillName.Cooking, 12, () => new List<Item> {}),
                new SkillData(SkillName.DetectHidden, 13, () => new List<Item> {}),
                new SkillData(SkillName.Discordance, 14, () => new List<Item> {}),
                new SkillData(SkillName.EvalInt, 15, () => new List<Item> {}),
                new SkillData(SkillName.Fencing, 16, () => new List<Item> {}),
                new SkillData(SkillName.Fishing, 17, () => new List<Item> {}),
                new SkillData(SkillName.Fletching, 18, () => new List<Item> {}),
                new SkillData(SkillName.Forensics, 19, () => new List<Item> {}),
                new SkillData(SkillName.Healing, 20, () => new List<Item> {}),
                new SkillData(SkillName.Herding, 21, () => new List<Item> {}),
                new SkillData(SkillName.Hiding, 22, () => new List<Item> {}),
                new SkillData(SkillName.Inscribe, 23, () => new List<Item> {}),
                new SkillData(SkillName.ItemID, 24, () => new List<Item> {}),
                new SkillData(SkillName.Lockpicking, 25, () => new List<Item> {}),
                new SkillData(SkillName.Lumberjacking, 26, () => new List<Item> {}),
                new SkillData(SkillName.Macing, 27, () => new List<Item> {}),
                new SkillData(SkillName.Magery, 28, () => new List<Item> {}),
                new SkillData(SkillName.Mining, 29, () => new List<Item> {}),
                new SkillData(SkillName.Musicianship, 30, () => new List<Item> {}),
                new SkillData(SkillName.Parry, 31, () => new List<Item> {}),
                new SkillData(SkillName.Peacemaking, 32, () => new List<Item> {}),
                new SkillData(SkillName.Poisoning, 33, () => new List<Item> {}),
                new SkillData(SkillName.Provocation, 34, () => new List<Item> {}),
                new SkillData(SkillName.RemoveTrap, 35, () => new List<Item> {}),
                new SkillData(SkillName.MagicResist, 36, () => new List<Item> {}),
                new SkillData(SkillName.Snooping, 37, () => new List<Item> {}),
                new SkillData(SkillName.SpiritSpeak, 38, () => new List<Item> {}),
                new SkillData(SkillName.Stealing, 39, () => new List<Item> {}),
                new SkillData(SkillName.Stealth, 40, () => new List<Item> {}),
                new SkillData(SkillName.Swords, 41, () => new List<Item> {}),
                new SkillData(SkillName.Tactics, 42, () => new List<Item> {}),
                new SkillData(SkillName.Tailoring, 43, () => new List<Item> {}),
                new SkillData(SkillName.TasteID, 44, () => new List<Item> {}),
                new SkillData(SkillName.Tinkering, 45, () => new List<Item> {}),
                new SkillData(SkillName.Tracking, 46, () => new List<Item> {}),
                new SkillData(SkillName.Veterinary, 47, () => new List<Item> {}),
                new SkillData(SkillName.Wrestling, 48, () => new List<Item> {})
            ...
            switch (info.ButtonID)
            {
                ...
                case 1:
                {
                    ...
                    List<SkillName> selectedSkillNames = new List<SkillName>();
